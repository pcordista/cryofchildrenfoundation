...
<?php include 'components/atividade-saneamento-banner.php'; ?>

<?php include 'components/atividade-saneamento-descricao.php'; ?>

<?php include 'components/atividade-saneamento-galeria.php'; ?>
