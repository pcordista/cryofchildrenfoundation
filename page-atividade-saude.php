...
<?php include 'components/atividade-saude-banner.php'; ?>

<?php include 'components/atividade-saude-descricao.php'; ?>

<?php include 'components/atividade-saude-galeria.php'; ?>
