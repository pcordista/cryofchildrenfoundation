...
<?php include 'components/atividade-educacao-banner.php'; ?>

<?php include 'components/atividade-educacao-descricao.php'; ?>

<?php include 'components/atividade-educacao-galeria.php'; ?>
