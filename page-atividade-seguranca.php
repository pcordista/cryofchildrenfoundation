...
<?php include 'components/atividade-seguranca-banner.php'; ?>

<?php include 'components/atividade-seguranca-descricao.php'; ?>

<?php include 'components/atividade-seguranca-galeria.php'; ?>
