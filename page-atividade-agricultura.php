...
<?php include 'components/atividade-agricultura-banner.php'; ?>

<?php include 'components/atividade-agricultura-descricao.php'; ?>

<?php include 'components/atividade-agricultura-galeria.php'; ?>
